              ...
              <div key={rIdx} className="flex justify-center gap-8">
                {row.map((i) => (
                  <div key={i} className="flex flex-col items-center gap-2">
                    ...
                    >
                      {i === 1 ? (
                        <img src="/WhatsApp%20Image%202026-01-03%20at%2022.22.15.jpeg" alt="Title Sponsor" className="w-3/4 h-3/4 object-contain rounded-full" />
                      ) : i === 2 ? (
                        <img src="/WhatsApp%20Image%202026-01-03%20at%2022.22.16.jpeg" alt="Silver Sponsor" className="w-full h-full object-cover rounded-full" />
                      ) : i === 3 ? (
